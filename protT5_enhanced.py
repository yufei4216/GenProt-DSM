...
class Config:
    ...
    # output
    out_dir: str = r"/home/yufei/20251210up/pred/protT5_enhanced"
...
# =========================
# Sweep runner (protT5 backbone ablation)
# =========================
PROT_T5_BACKBONE_SWEEP: List[str] = [
    "transformer",
    "tcn",
    "bilstm",
    "cnn",
...
def main(cfg: Config = CFG):
    """
    Run the full pipeline sequentially for each protT5 module choice.
    - protT5 branch backbone: swept over PROT_T5_BACKBONE_SWEEP
    - GPN-MSA branch backbone: forced to "none" (i.e., remove the BiLSTM module; keep other processing unchanged)
    Outputs are written under: cfg.out_dir / protT5_<backbone>/
    """
    ...
    for b in PROT_T5_BACKBONE_SWEEP:
        run_cfg = copy.deepcopy(cfg)
        run_cfg.t5_backbone = b
        run_cfg.gpn_backbone = "none"
        run_cfg.out_dir = os.path.join(root_out, f"protT5_{b}")

        print("\n" + "=" * 100)
        print(f"[SWEEP] protT5 backbone = {b} | gpn backbone = none")
